...
class YOLO(object):
    _defaults = {
        "model_path": 'logs/Epoch9-Total_Loss12.8053-Val_Loss8.6212.pth',
    ...
    def detect_image(self, image):
        ...
        for i, c in enumerate(top_label):
            ...
            # ddd += '{} {} {} {} {} '.format(c + 1, left, bottom, right, top)
            allist.append([score, c + 1, left, top, right, bottom])

        resultstr = ""
        detlist = sorted(allist, key=itemgetter(0), reverse=True)
        for k in detlist:
            resultstr += '{} {} {} {} {} '.format(k[1], k[2], k[3], k[4], k[5])
